...
\begin{multicols}{4}
    ...
    d) 364
\end{multicols}
 \item The value of $\lim_{r \to \infty}\sbrak{r}+\sbrak{2r}+\dots\sbrak{nr}/\sbrak{n^2}$, where r is a non-zero number and \sbrak{r} denotes the greatest integer less than or equal to $r$, is equal to :
 \begin{multicols}{4}
     a) 0\\
     b) $r$\\
     c) $r/2$\\

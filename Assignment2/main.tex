...
\begin{multicols}{4}
    ...
    d) 364
\end{multicols}
 \item The value of $\frac{\lim_{r \to \infty}\sbrak{r}+\sbrak{2r}+\dots\sbrak{nr}}{\sbrak{n^2}}$, where r is a non-zero number and \sbrak{r} denotes the greatest integer less than or equal to $r$, is equal to :
 \begin{multicols}{4}
     a) 0\\
     b) $r$\\
     c) $r/2$\\
...
\item The number of solutions of the equation $\sin^{-1}\sbrak{x^2+\brak{\frac{1}{3}}}+\cos^{-1}\sbrak{x^2-\brak{\frac{2}{3}}}=x^2$, for $x \in \sbrak{-1,1}$, and \sbrak{x} denotes the greatest integer less than or equal to $x$, is:
\begin{multicols}{4}
    a) 0\\
    b) 2\\
    c) 4\\
...
\item Let $\vec{x}$ be a vector in the plane containing vectors $a=2i-j+k$ and $b=i+2j-k$. If the vector $\vec{x}$ is perpendicular to \brak{3i+2j-k} and its projection on $a$ is $\frac{17\sqrt{6}}{2}$, then the value of $x^2$ is equal to 
